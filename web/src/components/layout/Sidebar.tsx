...
import { House, MagnifyingGlass, Heart, UsersThree, User, Flag, CalendarBlank, ChatCircle, Gear, Star, Clock, PlayCircle, FilmStrip, ShieldCheck, ShareNetwork } from '@phosphor-icons/react';
