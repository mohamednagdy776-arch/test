  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3">
        <button type="button" onClick={() => window.location.href = `${process.env.NEXT_PUBLIC_API_URL}/auth/oauth/google?redirect_uri=${encodeURIComponent(window.location.origin + '/dashboard')}`}
