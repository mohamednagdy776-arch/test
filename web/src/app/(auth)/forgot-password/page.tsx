        ...
        <div className="rounded-2xl bg-[#FDFAF5] shadow-elevated p-8">
          <div className="mb-8 text-center">
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl text-[#FDFAF5] font-bold text-2xl shadow-md" style={{ background: 'linear-gradient(135deg, #213448, #547792)' }}>
              <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M15 17h5l-1.405-1.405A2.352 2.352 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg>
            </div>
            <h1 className="text-2xl font-bold text-[#213448]">نسيت كلمة المرور</h1>
            <p className="mt-1.5 text-sm text-[#547792]">أدخل بريدك الإلكتروني لإرسال رابط الاستعادة</p>
          </div>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {success && (
              <div className="flex items-center gap-3 rounded-xl border border-[#52B069]/30 bg-[#52B069]/10 px-4 py-3">
                ...
                <p className="text-sm font-medium text-[#52B069]">تم إرسال رابط الاستعادة إلى بريدك الإلكتروني</p>
              </div>
            )}
            {!success && (
              <>
