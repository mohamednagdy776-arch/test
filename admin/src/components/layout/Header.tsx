...
export const Header = () => {
  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-[#C8D8DF]/60 bg-[#FDFAF5]/80 backdrop-blur-xl px-6">
      <div className="flex items-center gap-2">
        <div className="status-online" />
        <span className="text-sm font-medium text-[#547792]">System Online</span>
      </div>
      <button onClick={handleLogout} className="flex items-center gap-2 rounded-xl border border-[#C8D8DF] px-3 py-2 text-sm font-medium text-[#547792] hover:bg-[#D4E8EE] hover:text-[#213448] transition-all duration-200">
